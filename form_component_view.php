  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
         ...
         <!--  <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="responsive_table.php">Sensor Reading Table</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> View Data</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Please fill out all the blanks to view sensor data.</h4>
              <form class="form-horizontal tasi-form" method="post" action="responsive_table.php">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name = "get_data">View</button>
                    </div>
                </div>
              </form>
            </div>
